...
// CODE HERE
uniq(names, uniqArr=> console.log(`The new names array with all the duplicate items removed is ${names}.`))
...
// CODE HERE 
 const each = (arr, cb) => arr.forEach((names,i) => cb(names, i))
